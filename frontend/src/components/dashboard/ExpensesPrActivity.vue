...
export default {
    ...
    methods: {
        ...
        sanitizeData: function(edges) {
            ...
            edges.forEach(e => {
                const activity = e.node.paymentSchedule.activity.details.name
                const idx = data.labels.findIndex(l => l === activity)
        ...
        renderChart: function(data) {
            this.chart_obj.data = {
                ...
                datasets: [
                    {
                        label: 'Udgifter fordelt på ydelse',
                        data: data.data,
...
<style>
    ...
    .expenses-pr-activity h2 {
        padding: .25rem 0 1rem;
        text-align: center;
    }
    .expenses-pr-activity fieldset {
        display: flex;
