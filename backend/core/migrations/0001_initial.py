# Generated by Django 2.2.1 on 2019-06-20 11:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cvr_number', models.CharField(blank=True, max_length=8)),
                ('name', models.CharField(max_length=128)),
                ('vat_factor', models.DecimalField(decimal_places=2, max_digits=5)),
            ],
        ),
        migrations.CreateModel(
            name='RelatedPerson',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval_level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='appropriations', to='core.ApprovalLevel')),
                ('case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appropriations', to='core.Case')),
                ('section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='appropriations', to='core.Sections')),
            ],
            options={
                'ordering': ('-modified', '-created'),
                'get_latest_by': 'modified',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_providers', models.ManyToManyField(related_name='activity_catalogs', to='core.ServiceProvider')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_provider', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='activities', to='core.ServiceProvider')),
            ],
            options={
                'ordering': ('-modified', '-created'),
                'get_latest_by': 'modified',
