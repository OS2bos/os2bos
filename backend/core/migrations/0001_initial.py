# Generated by Django 2.2.1 on 2019-08-21 09:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_units', models.PositiveIntegerField(blank=True, null=True, verbose_name='betalingsenheder')),
        ...
        migrations.AddField(
            model_name='case',
            name='team',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='cases', to='core.Team', verbose_name='team'),
        ),
        migrations.CreateModel(
            name='Appropriation',
            fields=[
                ...
                ('approval_level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='appropriations', to='core.ApprovalLevel', verbose_name='bevillingsniveau')),
                ('approval_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='approved_appropriations', to=settings.AUTH_USER_MODEL, verbose_name='bevilget af bruger')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_activity_for', models.ManyToManyField(blank=True, related_name='main_activities', to='core.Section', verbose_name='hovedaktivitet for paragraffer')),
                ('service_providers', models.ManyToManyField(blank=True, related_name='supplied_activities', to='core.ServiceProvider', verbose_name='leverandører')),
                ('supplementary_activity_for', models.ManyToManyField(blank=True, related_name='supplementary_activities', to='core.Section', verbose_name='følgeudgift for paragraffer')),
            ],
            options={
