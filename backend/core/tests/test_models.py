...
class ActivityTestCase(TestCase, BasicTestMixin):
    ...
    def test_total_cost_deleted_expected_activity(self):
        now = timezone.now()
        start_date = date(year=now.year, month=1, day=1)
        end_date = date(year=now.year, month=1, day=15)
        case = create_case(self.case_worker, self.municipality, self.district)
        appropriation = create_appropriation(case=case)
        # 15 days, daily payments of 500.
        activity = create_activity(
    ...
    def test_account_number_main_activity_no_activity_category(self):
        case = create_case(self.case_worker, self.municipality, self.district)
        section = create_section()
        appropriation = create_appropriation(case=case, section=section)
    ...
    def test_account_number_supplementary_activity_no_activity_category(
        self,
    ):
        case = create_case(self.case_worker, self.municipality, self.district)
        section = create_section()
        ...
        # no activity category is found.
        self.assertEqual(suppl_activity.account_number, None)
    ...
    def test_account_alias_supplementary_activity_no_activity_category(
        self,
    ):
        case = create_case(self.case_worker, self.municipality, self.district)
        section = create_section()
    ...
    def test_activity_category_main_activity(self):
        case = create_case(self.case_worker, self.municipality, self.district)
        section = create_section()
        appropriation = create_appropriation(case=case, section=section)
        ...
        self.assertEqual(activity.activity_category, activity_category)

    def test_activity_category_no_main_activity(self):
        case = create_case(self.case_worker, self.municipality, self.district)
        section = create_section()
        appropriation = create_appropriation(case=case, section=section)
        ...
        # No main activity is found.
        self.assertIsNone(suppl_activity.activity_category)

    def test_activity_category_supplementary_activity(self):
        case = create_case(self.case_worker, self.municipality, self.district)
        section = create_section()
        appropriation = create_appropriation(case=case, section=section)
        ...
        self.assertEqual(suppl_activity.activity_category, activity_category)

    def test_activity_category_supplementary_activity_no_activity_category(
        self,
    ):
        case = create_case(self.case_worker, self.municipality, self.district)
        section = create_section()
        ...
        # no activity category is found.
        self.assertEqual(suppl_activity.activity_category, None)
...
class PaymentTestCase(TestCase, BasicTestMixin):
    ...
    def test_payment_save_account_alias_saved(self):
        ...
        # account alias should come from account_alias while not paid.
